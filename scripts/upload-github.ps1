...
$include = @(
  ...
  'scripts/verify-dedup.mjs', 'scripts/verify-scan-dedup.cjs', 'scripts/verify-layers.cjs',
  'scripts/make-e2e-corpus.ps1', 'scripts/make-workflow-corpus.ps1', 'scripts/build-release.ps1',
